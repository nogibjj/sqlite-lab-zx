...
def load(dataset="/workspaces/sqlite-lab-zx/data/Grocery.csv"):
    ...
    c.execute("CREATE TABLE GroceryDB (id INT PRIMARY KEY,general_name, count_products, ingred_FPro, avg_FPro_products, avg_distance_root, ingred_normalization_term, semantic_tree_name, semantic_tree_node)")
    #insert
